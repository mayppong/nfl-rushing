defmodule Rushing.PlayerTest do
  ...
  describe "stats" do
    ...
    @valid_attrs %{att: 42, att_per_game: 120.5, avg: 120.5, first: 42, first_percent: 120.5, forty_plus: 42, fum: 42, lng: 42, lng_t: false, player: "some player", position: "some position", td: 42, team: "some team", twenty_plus: 42, yds: 42, yds_per_game: 42}
